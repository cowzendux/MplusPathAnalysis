...
##Usage
**MplusPathAnalysis(inpfile, runModel, viewOutput, latent, model, covar, covEndo, covExo, usevariables, indirect, identifiers, wald, categorical, censored, count, nominal, cluster, weight, datasetName, datasetLabels, indDatasetName, waittime)**
