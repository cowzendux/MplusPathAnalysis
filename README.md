...
## Usage
**MplusPathAnalysis(inpfile, runModel, viewOutput, latent, model, covar, covEndo, covExo, useobservations, indirect, identifiers, wald, categorical, censored, count, nominal, cluster, weight, datasetName, datasetLabels, indDatasetName, miThreshold, waittime)**
