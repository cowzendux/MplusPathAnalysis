...
cluster = "school")**
* This would test a regression model where a Treatment (Tx) is expected to affect attitudes towrd children (att_ch). Years of experience teaching (yrs_tch), teacher age (age), and teacher gender (gender) are included as covariates.  * CO is allowed to covary with both ES and IS. 
