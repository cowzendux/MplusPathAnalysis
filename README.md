...
## Usage
**MplusPathAnalysis(inpfile, runModel, viewOutput, suppressSPSS, latent, model, means, covar, covEndo, covExo, MLR, useobservations, indirect, identifiers, meanIdentifiers, wald, constraint, categorical, censored, count, nominal, cluster, weight, datasetName, datasetLabels, indDatasetName, indDatasetLabels, waittime)**
...
* Estimates of CO are generated for low, medium, and high values of education.
